# PoziTone version history (changelog)

> [История изменений (версий) PoziTone](HISTORY_ru.md).
...
* **_Voice control_**. <sup>(Enable in Options!)</sup>

<a href="https://user-images.githubusercontent.com/5961162/31848204-6cfa2868-b5e1-11e7-9ea7-9d9811aef347.png">
  <img
    src="https://user-images.githubusercontent.com/5961162/31848164-74989dee-b5e0-11e7-97c2-9d53d69482f4.png"
    width="250"
    height="174"
    alt="PoziTone v0.7.0 * New: voice control. (Enable in Options!)"
    title="PoziTone v0.7.0 * New: voice control. (Enable in Options!)"
      >
</a>

### Fixed

* Options wouldn't always properly work or display a requested tab.
* DI.fm module wouldn't work.
...
> [Important message from the developers!](https://poziworld.github.io/PoziTone/message/v0.4/?lang=en&ref=history)
